    ...
    for (const characterName of characterNames) {
      ...
      try {
        ...
        const profile: CharacterProfile = {
          ...
          images: {
            filename_icon: (fullCharacter.images as any)?.filename_icon,
            filename_iconCard: (fullCharacter.images as any)?.filename_iconCard,
            filename_sideIcon: (fullCharacter.images as any)?.filename_sideIcon,
            filename_gachaSplash: (fullCharacter.images as any)?.filename_gachaSplash,
            filename_gachaSlice: (fullCharacter.images as any)?.filename_gachaSlice,
          },
